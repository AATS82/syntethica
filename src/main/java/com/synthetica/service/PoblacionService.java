    ...
    public static class PerfilSintetico {
        ...
        public String toPromptContext() {
            return String.format(
                    ...
                    + "Educación: %s. Ocupación: %s. NSE: %s (%s). Zona: %s. "
        ...
        private String describirNse() {
            switch (nivelSocioeconomico) {
                case "Bajo":       return "ingresos del quintil inferior, presupuesto muy ajustado, prioriza necesidades básicas";
                case "Medio-bajo": return "ingresos moderados bajos, preocupación frecuente por los gastos, acceso limitado a crédito";
                case "Medio":      return "ingresos medios, cubre necesidades y algunos gustos, sensible a cambios de precio";
                case "Medio-alto": return "ingresos sobre el promedio, acceso a bienes y servicios de calidad";
                case "Alto":       return "ingresos altos, sin restricciones económicas relevantes, expectativas elevadas de calidad";
                default:           return "";
            }
        }
